define([
    ...
    return declare(Menu, {
        ...
        postCreate: function () {
            ...
            //Time
            if ((controlOptions.enableTime === true)) {
                menu.addChild(new MenuItem({
                    label: i18n.enableTime,
                    onClick: function () {
                        controller._enableTimeToLayer(layer);
                    }
                }));
            }
            ...
            // metadata link
            // service url
            if (controlOptions.metadataUrl.include === true && controlOptions.metadataUrl.url) {
                menu.addChild(new MenuSeparator());
                menu.addChild(new MenuItem({
                    label: i18n.metadata,
                    onClick: function () {
                        window.open(controlOptions.metadataUrl.url, '_blank');
                    }
                }));
            }
            // custom url
